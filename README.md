...
- [Reviewed Hermes handoff and gate status](DG_EVIDENCE_PACKET.md)
- [EDD-03 listener recovery evidence](docs/evidence/phase1/EDD03_LISTENER_RECOVERY.md)
- [R3a local readiness and lifecycle evidence](docs/evidence/phase1/R3A_LOCAL_READINESS.md)
...
The Hermes handoff has been reviewed: earlier DG-1/DG-2 GO claims are superseded by ITERATE, and G1b awaits reproducible installed-route evidence. IPC now validates a strict wire schema and recovers from malformed/stalled clients and handler failures. Explicit pipe ACL/read-back and local readiness/start-disposal serialization have regression coverage. Full peer-security, admission, cold-process recovery, and process/window qualification remain open.
